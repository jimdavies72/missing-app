...
import backgroundHero from '../../media/hero-img.png';
  ...
  return (
    <div className="split-page">
      <section className="hero-container" 
        style={{ backgroundImage: `linear-gradient(rgba(0,0,0,.4),rgba(0,0,0,.3)), url(${backgroundHero})`,
                 backgroundSize: "cover",
                 backgroundRepeat: "no-repeat",
                 borderRadius: "0.375rem"}}>
        <h1>ICQ</h1>
        <p>Individual Concern Query aims to provide a platform to register and search for missing persons throughout the UK.</p>
      </section>
